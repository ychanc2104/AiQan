...
export default function HomePage() {
  ...
  return (
    <>
      {/* TikTok embed.js — loaded once for the whole page */}
      <Script src="https://www.tiktok.com/embed.js" strategy="lazyOnload" />

      <Header />

      {/*
        Mobile: feed sits directly below the fixed header, fills remaining viewport.
        Desktop: sidebar (sticky) + feed in a two-column layout.
      */}
      <div className="pt-14">
        {/* Mobile layout — no sidebar, feed manages its own scroll */}
