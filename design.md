...
> 版本：v0.3 | 更新日期：2026-04-16
> **核心理念：人與人互動即可訂閱 — 微型勞務 ＆ 情緒經濟平台**
> 定位：凡是可透過網路進行的人際互動與服務，均可在此訂閱或單次購買。初期以**在台東南亞社群**（移工、新住民、留學生）為首發市場，逐步擴展至全台及東南亞本地。
...
| 類別 | 範例 |
|:-----|:-----|
| **聲音／情緒陪伴** | 陪聊師、傾聽服務、虛擬戀人、心情日記回覆 |
| **學習／知識訂閱** | 陪讀書、語言家教、專業知識分享、線上課程 |
| **生活規劃服務** | 行程規劃、代購諮詢、簽證申請指引 |
| **單次專業服務** | 法律諮詢（初步）、財務建議、履歷健診 |
| **創作者內容** | 影音、文章、圖文、限定相簿（原有影音聚合） |

> 創作者可混搭多種服務類型，例如：一個人提供「訂閱月費看影音」+ 「單次購買一對一陪聊」。
...
| 一般台灣用戶 | — | 對情緒經濟／微型服務有需求，願意為人際互動付費 |

**創作者／服務提供者（被訂閱方）**

| 角色 | 說明 |
|:-----|:-----|
| 情緒陪伴者 | 陪聊師、傾聽者、虛擬戀人，依分鐘或月費計費 |
| 知識型創作者 | 語言家教、專業知識分享者、課程講師 |
| 生活服務者 | 行程規劃師、代購諮詢、簽證指引 |
| 影音創作者 | 原有聚合影音內容，可同時提供一對一服務 |
